        ...
        <div class="row bg-secondary py-2 px-lg-5">
            <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <a class="text-white pr-3" href="">Gmail</a>
                    <span class="text-white">|</span>
                    <a class="text-white px-3" href=""></a>
                    <span class="text-white">Address|</span>
                    <a class="text-white pl-3" href="">PhoneNumbers   </a>
                </div>
            </div>
        ...
        <div class="row py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <h1 class="Nelly PHONEBOOK"><span class="text-primary">NELLY</span>PHONEBOOK</h1>
                </a>
            </div>
            <div class="col-lg-8 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    <div class="d-inline-flex flex-column text-center pr-3 border-right">
                        <h6>neliavalencia0@gmail.com</h6>
                        <p class="m-0">Gmail</p>
                    </div>
                    <div class="d-inline-flex flex-column text-center px-3 border-right">
                        <h6>Paligawan Balete Batangas</h6>
                        <p class="m-0">Address|</p>
                    </div>
                    <div class="d-inline-flex flex-column text-center pl-3">
                        <h6>PhoneNumbers</h6>
                        <p class="m-0">09125981529</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="phonebook.html" class="nav-item nav-link">Phonebook</a>
                    </div>
                    <a href="contact.html" class="nav-item nav-link">Contact</a>
                </div>
                <a href="" class="btn btn-lg btn-primary px-3 d-none d-lg-block">NELIA
                VALENCIA</a>
            </div>
        </nav>
    </div>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block">Nelly LOGIN</h3>
                            <h1 class="display-3 text-white mb-3">NELLY PHONEBOOK</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">Enjoy yourself</h5>
                            <a href="" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">LOGIN</a>
                            <a href="" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4">PHONEBOOK</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block">Nelly login</h3>
                            <h1 class="display-3 text-white mb-3">NELLY PHONEBOOK</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">Going with the flow and a willingness to take life as it comes.</h5>
                            <a href="" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">LOGIN</a>
                            <a href="" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4">PHONEBOOK</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-5">
                <div class="row px-3">
                    <div class="col-12 p-0">
                        <img class="img-fluid w-100" src="https://c4.wallpaperflare.com/wallpaper/569/651/684/beautiful-girl-pic-1920x1080-wallpaper-preview.jpg" alt="">
                    </div>
                    <div class="col-6 p-0">
    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 mb-5">
                <h1 class="mb-3 display-5 text-capitalize text-white"><span class="text-primary"><span class="text-primary">NELLY</span></span>PHONEBOOK</h1>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <p><i class="fa fa-envelope mr-2"></i>Facebook.com</p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-md-right">
                <ul class="nav d-inline-flex">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" href="#">Gmail</a>
                    </li>
                    <li class="nav-item">
